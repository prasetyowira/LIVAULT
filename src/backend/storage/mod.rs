...
pub use audit_logs::{ add_entry as add_audit_log_entry, get_entries as get_audit_log_entries, compact_log as compact_audit_log, remove_logs as remove_audit_logs };
